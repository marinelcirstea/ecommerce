            ...
            <div className="relative max-w-xs w-full bg-white shadow-xl pb-12 flex flex-col overflow-y-auto">
                            ...
                            >
                              {category.featured.map((item) => (
                                <li key={item.name} className="flex">
                                  <NavLink href={item.href} className="text-gray-500">
                                    {item.name}
                                  </NavLink>
                                </li>
                              ))}
              ...
              <div className="border-t border-gray-200 py-6 px-4 space-y-6">
                {navigation.pages.map((page) => (
                  <div key={page.name} className="flow-root">
                    <NavLink href={page.href} className="-m-2 p-2 block font-medium text-gray-900">
                      {page.name}
                    </NavLink>
                  </div>
                ))}
              ...
              <div className="border-t border-gray-200 py-6 px-4 space-y-6">
                <div className="flow-root">
                  <NavLink href="/register" className="-m-2 p-2 block font-medium text-gray-900">
                    Create account
                  </NavLink>
                </div>
                <div className="flow-root">
                  <NavLink href="/login" className="-m-2 p-2 block font-medium text-gray-900">
                    Sign in
                  </NavLink>
                </div>
              </div>
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="h-16 flex items-center justify-between">
                  ...
                  <div className="flex-1 flex items-center lg:hidden">
                    ...
                    {/* Search */}
                    <NavLink href="#" className="ml-2 p-2 text-gray-400 hover:text-gray-500">
                    ...
                    <div className="flex items-center lg:ml-8">
                      <div className="flex space-x-8">
                        <div className="hidden lg:flex">
                          <NavLink href="#" className="-m-2 p-2 text-gray-400 hover:text-gray-500">
                            <span className="sr-only">Search</span>
                            <SearchIcon className="w-6 h-6" aria-hidden="true" />
                          </NavLink>
                        </div>
                      ...
                      <div className="flow-root">
                        <NavLink href="#" className="group -m-2 p-2 flex items-center">
                          <ShoppingCartIcon
